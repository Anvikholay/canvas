...
label_planet = Label(root, text="Planet : ", bg="#262626")
label_planet_name = Label(root,font=("courier",18,"bold"),bg="#7D84B2")
label_planet_image = Label(root,bg="gold2", highlightthickness=5, borderwidth=2,relief=SOLID)
label_planet_gravity_radius = Label(root,font=("castellar"), bg="#EF6F6C")
label_planet_info = Label(root,font=("courier",10,"bold"), bg="#420039", wrap=500)
